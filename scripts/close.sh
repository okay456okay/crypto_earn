...
# 常见用法:
#   ./close_binance.sh -t BTC       # 关闭100个BTC订单，每次关闭10个
#   ./close_binance.sh -t BTC -p 0.0002  # 指定价格差异为0.0002
...
if ! ps auxww|grep -q "gateio_${exchange}_unhedge.py"; then
