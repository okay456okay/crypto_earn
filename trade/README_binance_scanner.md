...
1. BTCUSDT (BTC)
   ...
   价格波动率: 18.63%
   当前价格: $106898.000000
   价格区间: $94125.100000 - $111662.700000
   资金费率方向: positive
   资金费率一致性: 87.8% 正 / 12.2% 负
   平均资金费率: 0.000043 (0.05% 年化)
```

### JSON报告结构
```json
{
  "scanDate": "2025-05-30T00:12:32.559330",
  "scanParameters": {
  ...
  "qualifiedSymbols": [
    {
      ...
      "baseAsset": "BTC",
      "maxLeverage": 125,
      "priceVolatility": 0.1863,
      "fundingRateAnalysis": {
        "is_consistent": true,
        "direction": "positive",
        "positive_ratio": 0.8778,
        "negative_ratio": 0.1222,
        "avg_rate": 4.339e-05,
        "total_count": 90
      },
      "currentPrice": 106898.0,
      "priceRange": {
        "min": 94125.1,
        "max": 111662.7
      }
