...
class BybitScanner:
    def __init__(self, advance_time=0.320, open_position_time=1.0, funding_rate_threshold=-1.0, trade_amount_limit=100.0):
        """初始化Bybit扫描器
...
async def main():
    ...
    parser.add_argument('-a', '--advance-time', type=float, default=0.320,
                      help='提前平仓时间（秒），默认0.320秒')
