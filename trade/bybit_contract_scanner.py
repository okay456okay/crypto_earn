...
该脚本用于扫描Bybit所有合约交易对，找到符合以下条件的交易对：
1. 最近30天内价格波动小于20%
...
from config import bybit_api_key, bybit_api_secret, proxies, project_root
import ccxt
import time
import json
import pandas as pd
...
class BybitContractScanner:
    ...
    def __init__(self, api_key: str = None, api_secret: str = None,
        ...
        self.exchange = ccxt.bybit({
            ...
            'secret': api_secret or bybit_api_secret,
        ...
        self.report_file = os.path.join(self.reports_dir, f'bybit_contract_scan_{timestamp}.json')
        self.summary_file = os.path.join(self.reports_dir, f'bybit_contract_summary_{timestamp}.txt')
